                                          ...
                                          Padding(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                ...
                                                // Check if the ID number field contains exactly 15 digits
                                                if (idNumber.isNotEmpty &&
                                                    password.isNotEmpty) {
                                                  if (RegExp(r'^\d{15}$')
                                                      .hasMatch(idNumber)) {
                                                    // If the ID number is valid, navigate to the next page
                                                    context.pushNamed(
                                                      'homePage_active',
                                                    ...
                                                    // If the ID number is not valid, show an error message
                                                    ScaffoldMessenger.of(
                                                            context)
                                                        .showSnackBar(
                                                      const SnackBar(
                                                        content: Text(
                                                            'ID number must be exactly 15 digits.'),
                                                      ),
                                                    );
                                                  }
                                                } else {
                                                  // If either the ID number or password field is empty, show an error message

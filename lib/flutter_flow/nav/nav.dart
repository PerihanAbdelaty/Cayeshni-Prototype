      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'eWallet')
              : const EWalletWidget(),
        ),
        FFRoute(
          name: 'profilePage',
        ...
        FFRoute(
          ...
          path: '/homePageActive',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'homePage_active')
              : const HomePageActiveWidget(),
        ),
        FFRoute(
          name: 'paymentPlan_new',
          path: '/paymentPlanNew',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'paymentPlan_new')
              : const PaymentPlanNewWidget(),
        ),
        FFRoute(
          name: 'paymentPlan_exist',
          path: '/paymentPlanExist',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'paymentPlan_exist')
              : const PaymentPlanExistWidget(),
        )

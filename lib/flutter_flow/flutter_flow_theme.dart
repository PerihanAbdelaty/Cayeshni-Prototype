...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFA240BF);
  late Color secondary = const Color(0xFFFFBE00);
  late Color tertiary = const Color(0xFFCCAAEE);
  ...
  late Color primaryBackground = const Color(0xFFF3ECF6);
